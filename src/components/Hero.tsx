  ...
  return (
    <section className="relative min-h-[90vh] flex items-center pt-16 pb-4 overflow-hidden">
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-0 right-0 w-1/3 h-1/3 bg-gradient-to-bl from-book-50 to-book-100 rounded-bl-full opacity-80"></div>
        <div className="absolute bottom-0 left-0 w-1/2 h-1/2 bg-gradient-to-tr from-book-100 to-book-50 rounded-tr-full opacity-60"></div>
        <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-30"></div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="w-full lg:w-1/2 max-w-2xl pl-2 md:pl-4 pt-16 md:pt-20">
            ...
            <h1 className="heading-xl mb-8 text-balance" ref={headingRef}>
              <span className="text-book-500">Tech-Forward</span> Solutions to Streamline Your Back Office
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4" ref={ctaRef}>
              <a href="#contact" className="px-8 py-3 rounded-full bg-book-500 text-white font-medium transition-fast hover:shadow-lg hover:shadow-book-400/20 tech-hover text-center">
                Get Started Today
              </a>
              <a href="#services" className="px-8 py-3 rounded-full border border-book-200 text-navy-900 font-medium transition-fast hover:bg-book-50 hover:border-book-300 tech-hover text-center">
                Explore Solutions
              </a>
            </div>
            ...
            <div className="relative">
              <div className="w-72 h-72 md:w-96 md:h-96 bg-book-100 rounded-full flex items-center justify-center">
                <div className="w-[90%] h-[90%] tech-glass rounded-full flex items-center justify-center">
                  <BarChart3 size={120} className="text-book-500" strokeWidth={1.5} />
                </div>
              </div>
              
              <div className="absolute -right-4 top-12 tech-glass rounded-xl py-3 px-4 shadow-xl animate-float">
                <div className="flex items-center gap-2">
                  <Server size={16} className="text-book-500" />
              ...
              animationDelay: '1s'
                ...
                <div className="flex items-center gap-2">
                  <DollarSign size={16} className="text-book-500" />
        ...
        <div className="w-full flex justify-center mt-2">
          <div className={`${isMobile ? 'mb-1' : 'mb-2'} flex flex-col items-center`}>
            ...
            <a href="#empathy" className="w-8 h-8 rounded-full border border-book-200 flex items-center justify-center animate-bounce">
              <ChevronDown size={20} className="text-book-500" />
            </a>
          </div>
        </div>
      </div>

    ...
    <header className={cn('fixed top-0 left-0 right-0 z-50 transition-all duration-300', 
      ...
      <div className="container mx-auto px-6 sm:px-8 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Link 
            to="/about"
            className="hidden md:block px-6 py-2 rounded-full bg-tactomic-blue text-white font-medium hover:shadow-lg hover:shadow-tactomic-blue/20 transition-fast"
          >
            About
          </Link>
      ...
      <div className={cn("fixed inset-0 bg-white/95 backdrop-blur-md z-40 pt-24 px-6 transition-all duration-300 ease-in-out",
        ...
        <nav className="flex flex-col gap-6 items-center">
          <Link
            to="/about"
            className="mt-4 w-full px-6 py-3 rounded-full bg-tactomic-blue text-white font-medium text-center"

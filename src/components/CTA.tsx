...
const CTA = () => {
  ...
  return (
    <section 
      id="contact" 
      className="section-padding bg-book-600 text-white relative overflow-hidden"
      ref={sectionRef}
    >
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
          <div 
            ...
            ref={contentRef}
          >
            <h2 className="heading-lg mb-6">Ready to Transform Your Financial Management?</h2>
            <p className="text-white/90 mb-8 max-w-lg">
              Take the first step toward financial clarity and business growth. Schedule a free consultation to discuss your unique needs.
            </p>
            ...
            <div className="flex flex-col gap-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/80">Book a time that works for your schedule.</p>
                </div>
              </div>

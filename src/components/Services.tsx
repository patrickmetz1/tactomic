  ...
  return <section id="services" className="section-padding pt-4 md:pt-8 pb-16 md:pb-24 relative overflow-hidden" ref={sectionRef}>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 max-w-6xl mx-auto">
          {serviceItems.map((service, index) => <Card key={service.title} className="opacity-0 transition-all duration-300 hover:shadow-lg hover:-translate-y-1" ref={el => itemsRef.current[index + 1] = el} style={{
